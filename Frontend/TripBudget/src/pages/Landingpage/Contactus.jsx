...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        setIsLoading(true);
        await axios.post(apiUrl("/api/v1/users/form"), formData, {
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            ...
            {/* Mobile Hamburger — same breakpoint as desktop nav (md) */}
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  content: "piyus1232",
                  description:
                    "Code, updates, and ways to contribute to TripBudget.",
                  gradient: "from-slate-700 to-slate-900",
                  href: "https://github.com/piyus1232",
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-gradient-to-br ${contact.gradient} rounded-2xl p-8 text-white relative overflow-hidden group border border-white/10`}
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div className="relative z-10">
                      <Icon className="w-8 h-8 mb-4" />
                      <h3 className="text-2xl font-bold mb-4">{contact.title}</h3>
                      <p className="text-xl font-semibold mb-2 break-all">{contact.content}</p>
                      <p className="text-white/80">{contact.description}</p>
                      {contact.href && (
                        <a
                          href={contact.href}
                          ...
                          className="text-cyan-200 hover:text-white font-medium underline underline-offset-2 mt-4 inline-block"
                        >
                          {contact.linkLabel}
                        </a>
                      )}
