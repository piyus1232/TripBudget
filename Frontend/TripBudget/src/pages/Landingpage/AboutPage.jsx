...
import { MarketingMobileDrawer } from '../../components/marketing/MarketingMobileDrawer';
// import { motion, AnimatePresence } from 'framer-motion';
  ...
  const team = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=640&h=640&fit=crop&crop=faces&auto=format&q=85",
      description:
        "Product and full-stack engineering—turning complex travel data into a simple, fast planner for everyone.",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=640&h=640&fit=crop&crop=faces&auto=format&q=85",
      description:
        "Backend, APIs, and reliability—keeping trains, hotels, and maps in sync so your itinerary stays trustworthy.",
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-[440px] rounded-2xl border border-white/10 bg-[#12101c] shadow-2xl shadow-black/50 overflow-hidden"
        role="dialog"
        aria-modal="true"
      >
        <div
          className="pointer-events-none absolute inset-0 bg-gradient-to-br from-cyan-500/[0.12] via-transparent to-violet-600/[0.15]"
          aria-hidden
        />
        <div className="pointer-events-none absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-cyan-400/40 to-transparent" />
        <button
          type="button"
          onClick={onClose}
          className="absolute top-3 right-3 z-10 flex h-10 w-10 items-center justify-center rounded-xl text-slate-400 hover:text-white hover:bg-white/10 transition-colors"
          aria-label="Close"
        >
          <X className="w-5 h-5" />
        </button>
        <div className="relative px-6 sm:px-8 pt-12 pb-8">{children}</div>
      </motion.div>
    </motion.div>
  );
};
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            ...
            {/* Mobile Hamburger — md breakpoint matches Landing & Contact */}
            <div className="md:hidden bg-[#1a1a1a] hover:bg-[#2d2d2d] text-white p-2 rounded-md transition-colors">
              <motion.button
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-14">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-white via-slate-100 to-cyan-200/90 bg-clip-text text-transparent">
                Meet Our Team
              </h2>
              <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                Two builders behind TripBudget—shipping smarter travel planning for India.
              </p>
            </motion.div>

            <motion.div
              className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10 justify-items-stretch"
              variants={containerVariants}
            >
              {team.map((member, index) => (
                <motion.div
                  ...
                  className="relative flex flex-col items-center text-center rounded-2xl p-8 lg:p-9 bg-gradient-to-b from-slate-900/90 to-slate-950/90 border border-slate-700/60 shadow-xl shadow-black/20 hover:border-cyan-500/25 hover:shadow-cyan-950/20 transition-all duration-300 group overflow-hidden"
                >
                  <div
                    className={`pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-[0.09] transition-opacity duration-500 bg-gradient-to-br ${member.gradient}`}
                    aria-hidden
                  />
                  <motion.div
                  ...
                  >
                    <div className="relative inline-block">
                      <div
                        className={`rounded-full p-[3px] bg-gradient-to-br ${member.gradient} shadow-lg`}
                      >
                        <div className="rounded-full p-1 bg-slate-950">
                          <img
                            src={member.image}
                            alt={member.name}
                            className="w-32 h-32 lg:w-36 lg:h-36 rounded-full object-cover object-center"
                            loading="lazy"
                            decoding="async"
                          />
                        </div>
                      ...
                      <span
                        className="absolute bottom-1 right-1 h-3.5 w-3.5 rounded-full bg-emerald-400 ring-[3px] ring-slate-950"
                        aria-hidden
                      />
                    </div>
                  </motion.div>
                  ...
                  <motion.h3
                    className="text-xl lg:text-2xl font-bold text-white mb-1.5 group-hover:text-cyan-100 transition-colors"
                  ...
                  <motion.p
                    className="text-slate-400 text-sm leading-relaxed max-w-xs mx-auto group-hover:text-slate-300 transition-colors"
                    initial={{ opacity: 0, y: 8 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
