      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            ...
            {/* Mobile / tablet: hamburger whenever desktop nav is hidden (md+) */}
            ...
            >
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-1/2 p-4 sm:p-6">
                  ...
                  <button  onClick={() => setIsRegisterOpen(true)} className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 py-3 rounded-xl font-bold text-sm sm:text-base hover:from-blue-600 hover:to-cyan-600 transition-colors ">
                    Plan Now
                  </button>
                </div>
              </div>
