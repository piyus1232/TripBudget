...
useEffect(() => {
  ...
  return (
    <div className="flex flex-col sm:flex-row bg-[#171221] text-white min-h-screen w-full mb-4">
      ...
      <SideBar />
      {/* Main Content */}
      <main className="flex-1 w-full pt-14 pb-2 sm:pt-2 transition-all duration-300 ml-0 sm:ml-[280px] md:ml-[300px]">
        <div className="max-w-full w-full mx-auto px-4 sm:px-6 flex flex-col gap-6 [zoom:1] sm:[zoom:0.75]">
          <HeroSection />
          <TravelStats />
          <UpcomingTrip />
          <GroupTeaser />
